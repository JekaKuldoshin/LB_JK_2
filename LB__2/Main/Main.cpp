...
int main() {
	...
	while (true) {            // Цикл для меню
		...
		cout << "                                           Меню                                                 |" << endl;
		cout << "------------------------------------------------------------------------------------------------|" << endl;
		cout << "1 - Работа Show                              | 4 - Перегрузка оператора суммы '+'               |" << endl;
		cout << "2 - Перегрузка оператора присваивания '='    | 5 - Перегрузка оператора потокового ввода '>>'   |" << endl;
		cout << "3 - Перегрузка оператора соответствия '=='   | 6 - Перегрузка оператора потокового вывода '<<'  |" << endl;
		cout << "------------------------------------------------------------------------------------------------|" << endl;
		cout << "                                          7 - Выход                                             |" << endl;
		cout << "------------------------------------------------------------------------------------------------|" << endl;
