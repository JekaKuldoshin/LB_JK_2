...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {         //ÍÌÓÔÍ‡ ÓÍ
		Int64 flag = 0;
		if (textBox1->Text != "") {
			flag++;
		}
	...
	private: System::Void ÒÓı‡ÌËÚ¸¬‘‡ÈÎToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {  //—Óı‡ÌÂÌËˇ ‚ Ù‡ÈÎ
		Stream^ myStream;
	...
	private: System::Void Á‡ÔÓÎÌËÚ¸—‘‡ÈÎ‡ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {    //«‡ÔÓÎÌÂÌËÂ Ò Ù‡ÈÎ‡
		Stream^ myStream; 
